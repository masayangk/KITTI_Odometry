...
for seq_id in 00 01 02 03 04 05 06 07 08 09 10; do
    mv dataset/sequences/$seq_id/* dataset/$seq_id  # カラー画像
done
rm -r dataset
...
for seq_id in 00 01 02 03 04 05 06 07 08 09 10; do
    mv dataset/sequences/$seq_id/* dataset/$seq_id  # グレースケール画像
done
rm -r dataset
...
for seq_id in 00 01 02 03 04 05 06 07 08 09 10; do
    mv dataset/sequences/$seq_id/* dataset/$seq_id  # 点群データ
done
rm -r dataset
...
for seq_id in 00 01 02 03 04 05 06 07 08 09 10; do
    mv dataset/poses/$seq_id.txt dataset/$seq_id  # ポーズ
done
rm -r dataset
...
for seq_id in 00 01 02 03 04 05 06 07 08 09 10; do
    mv dataset/sequences/$seq_id/* dataset/$seq_id  # キャリブレーションデータ
done
rm -r dataset
...
for seq_id in 00 01 02 03 04 05 06 07 08 09 10; do
    mv dataset/sequences/$seq_id/* dataset/$seq_id  # ラベルデータ
done
rm -r dataset 
rm README
...
for seq_id in 00 01 02 03 04 05 06 07 08 09 10; do
    mv dataset/sequences/$seq_id/* dataset/$seq_id  # ボクセルデータ
done
rm -r dataset
